...
export default function PortfolioHomeTranslated() {
  ...
  useEffect(() => {
    const onScroll = () => { const max = document.documentElement.scrollHeight - window.innerHeight; setScrollProgress(max ? (window.scrollY / max) * 100 : 0); };

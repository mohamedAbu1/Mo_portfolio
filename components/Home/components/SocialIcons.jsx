...
export default function SocialIcons() {
  const icons = [
    ...
    { name: "Instagram", href: "https://www.instagram.com/webd66995/", color: "#E1306C", icon: FaInstagram },
    ...
    { name: "Facebook", href: "https://www.facebook.com/mohamed.abu.102566", color: "#1877F2", icon: FaFacebook },
